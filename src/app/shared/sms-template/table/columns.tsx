...
import CreateEditSmsTemplateModal from '../modal/create-edit-modal';

type Columns = {
  data: IGetSmsTemplatesResponse['data'];
  sortConfig?: any;
  handleSelectAll: any;
  checkedItems: string[];
...
type Row = IGetSmsTemplatesResponse['data'][number];
      ...
      <div className="flex items-center justify-end gap-3 pe-4">
        ...
        >
          <ActionIcon
            ...
            onClick={() =>
              openModal({
                view: <CreateEditSmsTemplateModal data={row} />,
                customSize: 'xl',
              })
            }
          >
        ...
        >
          <ActionIcon
            onClick={() =>
              openModal({
                view: <CreateEditSmsTemplateModal isView data={row} />,
                customSize: 'xl',
              })
            }
            size="sm"
