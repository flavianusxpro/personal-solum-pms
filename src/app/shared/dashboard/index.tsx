...
import Department from '@/app/shared/dashboard/department';
import TotalAppointment from '@/app/shared/dashboard/total-appointment';
import Patients from '@/app/shared/dashboard/patients';
