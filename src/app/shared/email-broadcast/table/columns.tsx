...
export const getColumns = ({
  ...
  {
    title: <HeaderCell title="Recipient Coupon" />,
    dataIndex: 'type',
    key: 'type',
    width: 200,
    render: (value: string) => value,
    ...
    render: (_: string, row: Row) => (
      <div className="flex items-center justify-center gap-3 pe-4">
        <Dropdown placement="bottom-end">
          ...
          <Dropdown.Menu className="divide-y">
            <div className="mb-2 flex items-center gap-2">
              <Button
                className="flex w-full gap-2 hover:border-gray-700 hover:text-gray-700"
                variant="outline"
                // onClick={() => {
                //   openModal({
        ...
        <DeleteModal
          isOpen={isOpen}
          setIsOpen={setIsOpen}
          title="Delete the email broadcast"
          description={`Are you sure you want to delete this #${row.id} email broadcast?`}
