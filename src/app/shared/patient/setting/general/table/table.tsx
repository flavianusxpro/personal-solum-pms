...
import { IParamGetTypes } from '@/types/paramTypes';
import { useGetTypes, useDeleteType } from '@/hooks/use-type';
import toast from 'react-hot-toast';

export default function TypeTable({}: {}) {
  const { openModal } = useModal();
  const [params, setParams] = useState<IParamGetTypes>({
    page: 1,
    perPage: 10,
    sort: 'DESC',
    search: undefined,
  ...
  const { data, isLoading: isLoadingType, refetch } = useGetTypes(params);
