...
import { useUpdateType } from '@/hooks/use-type';
...
export const getColumns = ({
  ...
  },
  {
    ...
    render: (value: boolean, row: Row) => {
      ...
      return getScheduleStatusBadge(status);
    },
  },
  {
    ...
    render: (_: string, row: Row) => (
      <div className="flex items-center justify-start gap-3">
        ...
        <DeletePopover
          ...
          description={`Are you sure you want to delete this #${row.id} type?`}
