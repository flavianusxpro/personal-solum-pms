...
export const GetColumns = ({
    ...
    return [
        ...
        {
            title: <HeaderCell title="Admission Date" />,
        ...
        {
            title: <HeaderCell title="Clinic Branch" />,
            dataIndex: 'clinicBranch',
            key: 'clinicBranch',
            width: 250,
            render: (data: any, _: any) => <span>{data}</span>
        },
        {
            title: <HeaderCell title="Attending Provider" />,
        ...
        {
            title: <HeaderCell title="Reason For Presentation" />,
            dataIndex: 'reasonForPresentation',
            key: 'reasonForPresentation',
            width: 320,
            render: (data: any, _: any) => <span>{data}</span>
        },
        {
            title: <HeaderCell title="Discharge Date" />,
                    ...
                    <Dropdown>
                        ...
                        <Dropdown.Menu>
                            <Dropdown.Item onClick={(e) => {
                                e.stopPropagation();
                                openModal({
                                    view: <ModalAddEditAdmissionHistory data={row} isEdit={true} />,
                                    customSize: '1100px',
                                });
                            }}>
