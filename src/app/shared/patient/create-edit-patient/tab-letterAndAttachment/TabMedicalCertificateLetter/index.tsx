...
import ModalAddEditMedicalCertificateLetter from './ModalAddEditMedicalCertificateLetter';
import ModalDetailMedicalCertificateLetter from './ModalDetailMedicalCertificateLetter';

const TabMedicalCertificateLetter = () => {
  ...
  const data = [
    ...
    },
    {
      id: 3,
      type: 'Light Duty',
      duration: '19/11/2025 - 25/11/2025',
    ...
    },
    {
      id: 5,
      type: 'Unfit for Work',
      duration: '15/11/2025 - 17/11/2025',
      createdBy: 'Dr. Emily',
      createdAt: '01/12/2025 7:56 AM',
    },
  ];
      ...
      <div>
        <ControlledTable
          ...
          onRow={(record, index) => ({
            onClick: () => {
              openModal({
                view: <ModalDetailMedicalCertificateLetter data={record} />,
                customSize: '700px',
              });
            },
          })}
            ...
            otherButton: [
              <div key='action-buttos' className='flex items-center gap-2'>
                <Button
                  onClick={() => {
                    openModal({
                      view: <ModalAddEditMedicalCertificateLetter />,
                      customSize: '1100px',
                    });
                  }}
                >
...
export default TabMedicalCertificateLetter