    ...
    <div>
      ...
      <div className="mx-auto mt-10 w-full max-w-screen-2xl">
        <div className="border-b border-dashed border-muted">
          <h4 className="rizzui-title-h4 mb-3 text-base font-medium text-gray-900">
        ...
        <div className="flex items-center gap-6 border-b border-dashed border-muted py-6">
          ...
          <div>
            <div className="mb-2 flex items-center gap-2">
              <h4 className="rizzui-title-h4 text-base font-medium text-gray-900 dark:text-gray-700">
        ...
        <div className="flex items-center gap-6 py-6">
          ...
          <div>
            <h4 className="rizzui-title-h4 mb-2 text-base font-medium text-gray-900 dark:text-gray-700">
              2020 Macbook Air M1
            </h4>
            <div className="flex items-center gap-2">
              <p className="rizzui-text-p text-sm font-normal text-gray-500">
