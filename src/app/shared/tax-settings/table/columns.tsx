...
type Row = IGetTaxesResponse['data'][number];
...
export const getColumns = ({
  ...
  {
    title: <HeaderCell title="TAX NAME" />,
    dataIndex: 'name',
    key: 'name',
    width: 200,
  ...
  },
  {
    ...
    render: (_: string, row: Row) => (
      <div className="flex items-center justify-end gap-3 pe-4">
        <Tooltip size="sm" content={'Edit Tax'} placement="top" color="invert">
          <ActionIcon
            size="sm"
            variant="outline"
            ...
            onClick={() =>
              openModal({
                view: <CreateEditTaxModal data={row} />,
              })
            }
          >
        ...
        <Tooltip size="sm" content={'View Tax'} placement="top" color="invert">
          <ActionIcon
            onClick={() =>
              openModal({
                view: <CreateEditTaxModal isView data={row} />,
              })
            }
            size="sm"
            variant="outline"
        ...
        <DeletePopover
          ...
          description={`Are you sure you want to delete this #${row.id} tax?`}
