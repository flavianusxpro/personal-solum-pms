export const messages = {
  ...
  mobileNumberMaximum: 'Mobile number must be 10 digits',
  mobileNumberMinimum: 'Mobile number must be 10 digits',
  mobileNumberRequired: 'Mobile number must start with "04"',
